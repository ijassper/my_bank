...
if file_data:
  ...
  query2 = "select borrower_name, loan_type, credit_rating from virtual_loan_data"
  ...
  grade_optin = st.selectbox("확인할 등급을 선택하세요.",df['credit_rating'].unique())

  selected_df = df[df['credit_rating'] == grade_optin]
